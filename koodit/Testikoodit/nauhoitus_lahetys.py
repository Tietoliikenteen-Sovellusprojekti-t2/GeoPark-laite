...
def nimiMuunnin (video_nro, video_koko, video_nimi, video_form, polku_local): #Funktio videon nimemämistä varten
    while os.path.isfile(video_koko):                                         #Tarkistaa onko kyseisellä nimellä olevaa videotiedostoa olemassa                
        video_nimi = "my_video%d" %(video_nro)                                #muodostetaan videon nimi uudestaan
        video_nro += 1                                                        #Nostetaan videon numeromuuttujaa yhdellä
        video_koko = polku_local + video_nimi + video_form                    #Muodostetaan videon koko polku uudestaan
        #print video_nimi
    return video_nimi                                                         #palautetaan videon nimi
